				...
				<div class="row">
					<div class="col-sm-4">
						<div class="logo pull-left">
							<a href="<?php echo Url::home(); ?>"><?= Html::img('@web/images/home/logo.png',['alt'=>'E-SHOPPER']); ?></a>
						</div>
					...
					<div class="col-sm-8">
						<div class="shop-menu pull-right">
							<ul class="nav navbar-nav">
								...
								<li><a href="cart.html" onclick="return getCart();"><i class="fa fa-shopping-cart"></i> Cart</a></li>
				...
				<div class="row">
					...
					<div class="col-sm-3">
						<div class="search_box pull-right">
							<form meyhod="get" action="<?= Url::to(['category/search'])?>">
